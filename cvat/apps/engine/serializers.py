...
import textwrap
from typing import Any, Dict, Iterable, Optional, OrderedDict, Union, List
...
class JobReadSerializer(_JobFilenamesMixin, serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('url', 'id', 'task_id', 'project_id', 'assignee', 'guide_id',
            ...
            'target_storage', 'source_storage', 'assignee_updated_date', 'filenames')
...
class SimpleJobSerializer(_JobFilenamesMixin, serializers.ModelSerializer):
    ...
    class Meta:
        model = models.Job
        fields = ('url', 'id', 'assignee', 'status', 'stage', 'state', 'type', 'filenames')
        read_only_fields = fields
...
class TaskReadSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('url', 'id', 'name', 'project_id', 'mode', 'owner', 'assignee',
            ...
            'assignee_updated_date', 'priority',
        )
        read_only_fields = fields
        extra_kwargs = {
...
class TaskWriteSerializer(WriteOnceMixin, serializers.ModelSerializer):
    ...
    class Meta:
        ...
        write_once_fields = ('overlap', 'segment_size', 'priority')
